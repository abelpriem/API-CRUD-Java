...
public class App {
     ...
     * switch (input) {
     * case "1":
     * SolicitudesDAO.crear("Abel", "Problema de acceso a la aplicación",
     * "Solicito asistencia para resolver un problema de acceso a la aplicación. No puedo iniciar sesión con mis credenciales, y he intentado restablecer la contraseña sin éxito. Agradezco cualquier ayuda para solucionar este inconveniente lo antes posible."
     * );
     * SolicitudesDAO.crear("Maria", "Error en el sistema",
     * "He encontrado un error en el sistema al intentar guardar mis datos. Aparece un mensaje de error que dice 'no se puede guardar el registro'. Solicito ayuda para resolverlo."
     * );
     * SolicitudesDAO.crear("Oscar", "Solicitud de nueva funcionalidad",
     * "Me gustaría proponer una nueva funcionalidad para la aplicación que permita a los usuarios personalizar su perfil. Creo que esto mejoraría la experiencia del usuario."
     * );
     * break;
     * case "2":
     ...
     * break;
     * case "3":
     * SolicitudesDAO.actualizar(1, "Problema de acceso a la aplicación",
